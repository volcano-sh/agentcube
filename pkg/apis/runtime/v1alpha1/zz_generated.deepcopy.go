...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxEgressRule) DeepCopyInto(out *SandboxEgressRule) {
	*out = *in
	if in.CIDRs != nil {
	...
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]SandboxNetworkPolicyPort, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxEgressRule.
func (in *SandboxEgressRule) DeepCopy() *SandboxEgressRule {
	if in == nil {
		return nil
	}
	out := new(SandboxEgressRule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxIngressRule) DeepCopyInto(out *SandboxIngressRule) {
	*out = *in
	if in.CIDRs != nil {
		in, out := &in.CIDRs, &out.CIDRs
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxIngressRule.
func (in *SandboxIngressRule) DeepCopy() *SandboxIngressRule {
	if in == nil {
		return nil
	}
	out := new(SandboxIngressRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SandboxNetworkPolicy) DeepCopyInto(out *SandboxNetworkPolicy) {
	*out = *in
	if in.AllowedEgress != nil {
		...
		*out = make([]SandboxEgressRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.AllowedIngress != nil {
		...
		*out = make([]SandboxIngressRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Custom != nil {
		...
		*out = new(SandboxNetworkPolicyCustomRules)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxNetworkPolicyCustomRules) DeepCopyInto(out *SandboxNetworkPolicyCustomRules) {
	*out = *in
	if in.Ingress != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxNetworkPolicyCustomRules.
func (in *SandboxNetworkPolicyCustomRules) DeepCopy() *SandboxNetworkPolicyCustomRules {
	if in == nil {
		return nil
	}
	out := new(SandboxNetworkPolicyCustomRules)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxNetworkPolicyPort) DeepCopyInto(out *SandboxNetworkPolicyPort) {
	*out = *in
	if in.Protocol != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxNetworkPolicyPort.
func (in *SandboxNetworkPolicyPort) DeepCopy() *SandboxNetworkPolicyPort {
	if in == nil {
		return nil
	}
	out := new(SandboxNetworkPolicyPort)
	in.DeepCopyInto(out)
	return out
}
