...
| `language` | Select | **Yes** | Programming language of the code. AgentCube includes a built-in Python interpreter. To use custom Python environments or other languages, you must upload and configure a custom code interpreter in AgentCube. |
| `code` | String | **Yes** | The source code to be executed. |
