...
func (rs *redisStore) loadSandboxesBySessionIDs(ctx context.Context, sessionIDs []string) ([]*types.SandboxStore, error) {
	if len(sessionIDs) == 0 {
		return nil, nil
	}
	...
	result := make([]*types.SandboxStore, 0, len(sessionIDs))
...
func (rs *redisStore) StoreSandbox(ctx context.Context, sandboxRedis *types.SandboxStore) error {
	if sandboxRedis == nil {
...
func (rs *redisStore) UpdateSandbox(ctx context.Context, sandboxRedis *types.SandboxStore) error {
	if sandboxRedis == nil {
...
func (rs *redisStore) ListExpiredSandboxes(ctx context.Context, before time.Time, limit int64) ([]*types.SandboxStore, error) {
	if limit <= 0 {
		return nil, nil
	}
...
func (rs *redisStore) ListInactiveSandboxes(ctx context.Context, before time.Time, limit int64) ([]*types.SandboxStore, error) {
	if limit <= 0 {
		return nil, nil
	}
