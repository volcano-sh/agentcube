...
func getSandboxStatus(sandbox *sandboxv1beta1.Sandbox) string {
	for _, condition := range sandbox.Status.Conditions {
		if (condition.Type == string(sandboxv1beta1.SandboxConditionReady) || condition.Type == string(sandboxv1alpha1.SandboxConditionReady)) && condition.Status == metav1.ConditionTrue {
