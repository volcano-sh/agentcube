...
func TestBuildNetworkPolicy_NilSpec(t *testing.T) {
	...
	np, err := buildNetworkPolicy("sandbox-1", "default", nil, testRouterSelector, testRouterNamespace)
	require.NoError(t, err)
	assert.Nil(t, np)
}

func TestBuildNetworkPolicy_Metadata(t *testing.T) {
	np, err := buildNetworkPolicy("my-sandbox", "my-ns", &runtimev1alpha1.SandboxNetworkPolicy{},
...
func TestBuildNetworkPolicy_DefaultRules(t *testing.T) {
	...
	np, err := buildNetworkPolicy("sb", "ns", &runtimev1alpha1.SandboxNetworkPolicy{},
		testRouterSelector, testRouterNamespace)
	require.NoError(t, err)
	require.NotNil(t, np)
...
func TestBuildNetworkPolicy_RouterCrossNamespace(t *testing.T) {
	...
	np, err := buildNetworkPolicy("sb", "user-ns", &runtimev1alpha1.SandboxNetworkPolicy{},
...
func TestBuildNetworkPolicy_SandboxNameLabel(t *testing.T) {
	np, err := buildNetworkPolicy("unique-sandbox", "test-ns", &runtimev1alpha1.SandboxNetworkPolicy{},
		testRouterSelector, testRouterNamespace)
	require.NoError(t, err)
	require.NotNil(t, np)
