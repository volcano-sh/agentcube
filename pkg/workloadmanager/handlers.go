...
//
// Stickiness is a soft hint: concurrent sessions may complete their patches in
// any order (last writer wins), and the annotation simply records whichever node
// the most recently completed session landed on. This is intentional — strict
// ordering would add complexity disproportionate to the value of a soft affinity
// preference that the scheduler may ignore anyway.
