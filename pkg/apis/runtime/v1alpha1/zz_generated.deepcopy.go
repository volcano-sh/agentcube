...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxNetworkPolicyRule) DeepCopyInto(out *SandboxNetworkPolicyRule) {
	*out = *in
	if in.CIDRs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxNetworkPolicyRule.
func (in *SandboxNetworkPolicyRule) DeepCopy() *SandboxNetworkPolicyRule {
	if in == nil {
		return nil
	}
	out := new(SandboxNetworkPolicyRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SandboxNetworkPolicy) DeepCopyInto(out *SandboxNetworkPolicy) {
	*out = *in
	if in.Egress != nil {
		...
		*out = make([]SandboxNetworkPolicyRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
